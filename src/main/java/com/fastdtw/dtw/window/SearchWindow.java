...
public abstract class SearchWindow {
    ...
    private final void expandSearchWindow(int radius) {
                        ...
                        // current search window
        {
            ...
            for (final Enumeration<ColMajorCell> cellIter = this.enumeration(); cellIter
                    .hasMoreElements();)
            ...
            for (int cell = 0; cell < windowCells.size(); cell++) {
                ...
                // move to upper left if possible
                ...
                // move to upper-right if possible
                ...
                // move to lower-left if possible
                ...
                // move to lower-right if possible
    ...
    // A private class that is a fail-fast enumeration through the search
    // window.
